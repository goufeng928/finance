# GF_PY3_CLASS/Python3_Path/PY3_Path_for_HTTP_URL.py
# Create by GF 2025-09-08 12:53

class PY3_Path_for_HTTP_URL(object):

    # Examples for Get URL Protocol:
    # >>> PHU = PY3_Path_for_HTTP_URL()
    # >>>
    # >>> Result = PHU.Get_URL_Protocol(URL = "https://www.msn.cn/zh-cn/play/arcade?ocid=cgbinghp")
    # >>> print(Result)
    # https:
    # >>> Result = PHU.Get_URL_Protocol(URL = "ftp://ftp.mirrorservice.org/sites/sourceware.org/pub/gcc/releases")
    # >>> print(Result)
    # ftp:
    ...
    # >>> PHU = PY3_Path_for_HTTP_URL()
    # >>>
    # >>> Result = PHU.Get_URL_Path(URL = "https://www.msn.cn/zh-cn/play/arcade?ocid=cgbinghp")
    # >>> print(Result)
    # www.msn.cn/zh-cn/play/arcade?ocid=cgbinghp
    # >>> Result = PHU.Get_URL_Path(URL = "ftp://ftp.mirrorservice.org/sites/sourceware.org/pub/gcc")
    # >>> print(Result)
    ...
    # >>> PHU = PY3_Path_for_HTTP_URL()
    # >>>
    # >>> Result = PHU.Get_URL_Basename(URL = "https://www.php.net/distributions/php-8.2.29.tar.gz")
    # >>> print(Result)
    # php-8.2.29.tar.gz
    # >>> Result = PHU.Get_URL_Basename(URL = "ftp://ftp.mirrorservice.org/sites/sourceware.org/pub/gcc")
    # >>> print(Result)
    # gcc
    ...
    # >>> PHU = PY3_Path_for_HTTP_URL()
    # >>>
    # >>> Result = PHU.Combining_URL_Protocol_and_URL_Path(URL_Protocol = "http:", URL_Path = "www.bing.com/images")
    # >>> print(Result)
    # http://www.bing.com/images
    # >>> Result = PHU.Combining_URL_Protocol_and_URL_Path(URL_Protocol = "ftp:", URL_Path = "ftp.mirrorservice.org/sites")
    # >>> print(Result)
    ...
    # >>> PHU = PY3_Path_for_HTTP_URL()
    # >>>
    # >>> Result = PHU.Backward(URL = "https://www.msn.cn/zh-cn/play/arcade?ocid=cgbinghp")
    # >>> print(Result)
    # https://www.msn.cn/zh-cn/play
    # >>> Result = PHU.Backward(URL = "ftp://ftp.mirrorservice.org/sites/sourceware.org/pub/gcc")
    # >>> print(Result)
